...
message.channel.send(`<a:865963806483808256:896694904019894282>
Fetching Informtion for the Pokemon if not working then its a error check message`).then(msg => {
